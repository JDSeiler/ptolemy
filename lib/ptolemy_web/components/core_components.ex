defmodule PtolemyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PtolemyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PtolemyWeb.Gettext, "errors", msg, opts)
    end
  end
